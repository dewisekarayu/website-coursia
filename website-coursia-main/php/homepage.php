...
<body>
  <header class="site-header">
    <div class="container header-inner">
      <div class="logo">
        <img src="../assets/logo.png" alt="Coursia">
      </div>
  ...
  <main>
    <section class="hero">
      <div class="container hero-grid">
        <div class="hero-left" data-aos="fade-right">
          ...
          <div class="hero-ctas">
            <a class="btn btn-outline" href="#">Login</a>
            <a class="btn btn-primary" href="#">Lihat Paket</a>
          </div>
    ...
    <section id="program" class="section container">
      ...
      <div class="grid-3">
        <article class="card card-kids" data-aos="fade-up">
          <div class="card-head">
            <img src="../assets/kids.jpeg" alt="Kids" class="thumb">
            <div>
          ...
          <div class="card-actions">
            <a class="btn btn-primary sm" href="#form">Gabung</a>
            <a class="btn btn-outline sm" href="#">Detail</a>
          </div>
        </article>

        <article class="card card-teens" data-aos="fade-up">
          <div class="card-head">
            <img src="../assets/teens.jpeg" alt="Teens" class="thumb">
            <div>
          ...
          <div class="card-actions">
            <a class="btn btn-success sm" href="#form">Gabung</a>
            <a class="btn btn-outline sm" href="#">Detail</a>
          </div>
        </article>
        ...
        <article class="card card-adult" data-aos="fade-up">
          <div class="card-head">
            <img src="../assets/adult.jpeg" alt="Adults" class="thumb">
            <div>
          ...
          <div class="card-actions">
            <a class="btn btn-warning sm" href="#form">Gabung</a>
            <a class="btn btn-outline sm" href="#">Detail</a>
          </div>
        </article>
      </div>
    ...
    <section class="section container">
      <h2 class="section-title" data-aos="fade-up">Kenapa Pilih Coursia?</h2>
      <div class="grid-3">
        <div class="feature-card" data-aos="fade-up">
          <img src="../assets/setfir.jpg" alt="">
          <h4>Pengajar Bersertifikat</h4>
          <p class="muted">TOEFL/IELTS. Pengalaman mengajar semua usia.</p>
        </div>
        <div class="feature-card" data-aos="fade-up">
          <img src="../assets/mthd.jpg" alt="">
          <h4>Metode Interaktif</h4>
          <p class="muted">Project-based learning, games, simulasi ujian.</p>
        </div>
        <div class="feature-card" data-aos="fade-up">
          <img src="../assets/lapber.jpeg" alt="">
          <h4>Laporan Perkembangan</h4>
          <p class="muted">Progress tracking & feedback personal setiap bulan.</p>
        </div>
      </div>
    </section>
    ...
    <section id="pengajar" class="section container bg-soft">
      ...
      <div class="grid-4">
        <div class="teacher-card">
          <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=500&q=60&auto=format&fit=crop&ixlib=rb-4.0.3&s=placeholder" alt="Anna">
          <h4>Anna Williams</h4>
          <p class="muted">TOEFL • Kids & IELTS</p>
        </div>
        <div class="teacher-card">
          <img src="https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?w=500&q=60&auto=format&fit=crop&ixlib=rb-4.0.3&s=placeholder" alt="Rizky">
          <h4>Rizky Pratama</h4>
        ...
        <div class="teacher-card">
          <img src="https://images.unsplash.com/photo-1544006659-f0b21884ce1d?w=500&q=60&auto=format&fit=crop&ixlib=rb-4.0.3&s=placeholder" alt="John">
          <h4>John Carter</h4>
    ...
    <section id="pricing" class="section container">
      ...
      <div class="grid-3">
        <div class="pricing-card">
          ...
          <a class="btn btn-primary" href="#form">Pilih</a>
        </div>
        ...
        <div class="pricing-card">
          ...
          <a class="btn btn-success" href="#form">Pilih</a>
        </div>
        ...
        <div class="pricing-card">
          ...
          <a class="btn btn-warning" href="#form">Pilih</a>
        </div>
      </div>
    </section>

    <section class="section container bg-gradient-test">
  ...
  <script>
    ...
    if (form) {
      form.addEventListener('submit', function (e) {
        e.preventDefault();
        alert('Terima kasih! Tim Coursia akan menghubungi Anda untuk jadwal trial. (Demo)');
        this.reset();
      });
    }
    ...
    if (waBtn) {
      waBtn.addEventListener('click', function () {
        window.open('https://wa.me/62812xxxxxxxx?text=Halo%20Coursia,%20saya%20ingin%20minta%20trial', '_blank');
      });
    }
  </script>
</body>
